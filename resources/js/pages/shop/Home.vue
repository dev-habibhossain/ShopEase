...
<template>
    ...
    >
        ...
        >
            ...
            <button
                ...
                class="absolute top-1/2 left-4 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-gray-900 shadow transition hover:bg-white focus:ring-2 focus:ring-primary-600 focus:outline-none md:flex"
            >
                <svg
                    class="h-6 w-6"
                    fill="none"
            ...
            <button
                ...
                class="absolute top-1/2 right-4 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-gray-900 shadow transition hover:bg-white focus:ring-2 focus:ring-primary-600 focus:outline-none md:flex"
            >
                <svg
                    class="h-6 w-6"
                    fill="none"
            ...
            <div
                class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-primary-700/40 to-transparent"
            ></div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-4 py-6 md:grid-cols-4 md:gap-6">
                <div class="flex items-center gap-3">
                    <span
                        class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-50 text-primary-600"
                    >
                        <svg
                            class="h-5 w-5"
                            fill="none"
    ...
    <section class="border-b border-gray-200 bg-white py-10 md:py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-6 text-center sm:grid-cols-4">
                <div>
                    <p
                        class="font-display text-3xl font-extrabold tracking-tight text-primary-600 md:text-4xl"
                    >
                        50K+
                    </p>
                ...
                <div>
                    <p
                        class="font-display text-3xl font-extrabold tracking-tight text-primary-600 md:text-4xl"
                    >
                        4.8<span class="text-lg text-gray-400">/5</span>
                    </p>
    ...
    <section id="categories" class="bg-white py-12 md:py-16 lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex items-end justify-between">
                <div>
                    <h2
                        class="font-display text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl"
                    >
                        Shop by category
                    </h2>
                ...
                <Link
                    href="/shop"
                    class="hidden items-center gap-1 text-sm font-medium text-primary-600 hover:text-primary-700 sm:inline-flex"
                >
                    All categories
                    <svg
                        class="h-4 w-4"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex items-end justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 md:text-base">
                        Loved most by our customers this month.
                    </p>
                </div>
                <Link
                    href="/shop"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex items-end justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 md:text-base">
                        Just landed — be the first to grab them.
                    </p>
                </div>
                <Link
                    href="/shop"
    ...
    <!-- ============================ TESTIMONIALS ============================ -->
    <section
        class="bg-gray-100 py-12 md:py-16 lg:py-24"
    ...
    >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 text-center">
                ...
                <p class="mt-2 text-sm text-gray-600 md:text-base">
                    Real reviews from real ShopEase shoppers across Bangladesh.
                </p>
            </div>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
                ...
                >
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-gray-600">
                        Ordered a phone case and it arrived in two days, well
                        before I expected. Cash on delivery made it an easy
                        first purchase.
                    </p>
                    <div class="mt-4 flex items-center gap-3">
                        <img
                            src="https://placehold.co/80x80/F5F3FF/7C3AED?text=RA"
                            alt="Rina Akter"
                            class="h-10 w-10 rounded-full border border-primary-50 object-cover"
                        />
                        <div>
                            <p class="text-sm font-semibold text-gray-900">
                                Rina Akter
                ...
                >
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-gray-600">
                        Great prices on electronics and the size guide on the
                        clothing pages actually matches what shows up. Will keep
                        shopping here.
                    </p>
                    <div class="mt-4 flex items-center gap-3">
                        <img
                            src="https://placehold.co/80x80/F5F3FF/7C3AED?text=TH"
                            alt="Tanvir Hasan"
                            class="h-10 w-10 rounded-full border border-primary-50 object-cover"
                        />
                        <div>
                ...
                >
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-gray-600">
                        Customer support helped me change my delivery address
                        after the order was placed. Small thing, but it made me
                        trust the shop more.
                    </p>
                    <div class="mt-4 flex items-center gap-3">
                        <img
                            src="https://placehold.co/80x80/F5F3FF/7C3AED?text=NJ"
                            alt="Nusrat Jahan"
                            class="h-10 w-10 rounded-full border border-primary-50 object-cover"
                        />
                        <div>
    ...
    <section class="bg-primary-600">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
            ...
            >
                <div class="max-w-lg">
                    <h2
                        class="font-display text-2xl font-extrabold tracking-tight text-white md:text-3xl"
                    >
                        Get 10% off your first order
                    </h2>
                    <p class="mt-2 text-sm text-primary-50 md:text-base">
                ...
                >
                    ...
                    <input
                        ...
                        class="w-full rounded-lg border border-transparent bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-white focus:outline-none"
                    />
                    <button
                        type="submit"
                        class="shrink-0 rounded-lg bg-accent-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-accent-700 focus:ring-2 focus:ring-white focus:outline-none"
                    >
                        Subscribe
                    </button>
                </form>
